...
namespace HotelListing.Controllers
{
    ...
    public class HotelController : ControllerBase
    {
        ...
        [HttpGet("{id:int}", Name ="GetHotel")] //query parameter
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> CreateHotel([FromBody] UpsertHotelDTO hotelDTO)
        {
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> UpdateHotel(int id, [FromBody] UpsertHotelDTO hotelDTO)
        {
